...
namespace Noyau.Model
{
    ...
    public class Player : IPlayer
    {
        ...
        /// <summary>
        /// Calcule la plus longue route du joueur en parcourant ses routes actuellement construites.
        /// </summary>
        /// <returns>La longueur de la plus longue route du joueur</returns>
        ...
        /// <summary>
        /// Fonction permettant de savoir si l'on peut connecter deux routes ensembles.
        /// Cette fonction sert a l'algorithme de calcul de la plus longue route.
        /// </summary>
        /// <param name="firstRoad">L'emplacement de la premiere route</param>
        /// <param name="secondRoad">L'emplacement de la seconde route</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Fonction permettant de deserialiser la classe Player.
        /// Cette fonction est necessaire pour le transfert d'informations par le reseau.
        /// </summary>
...
/// <summary>
/// Classe auxiliaire utilisee pour la deserialisation de Player.
/// </summary>
