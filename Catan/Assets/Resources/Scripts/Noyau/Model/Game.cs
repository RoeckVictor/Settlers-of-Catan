...
namespace Noyau.Model
{
    ...
    public class Game : IGame
    {
        ...
        public Game(Guid gameId, int playerNumber, int iaNumber, IHexGrid customGrid = null)
        {
            ...
            CurrentPlayer = random.Next(0, firstIAIndex);
        }
        ...
        public void Steal(Coordinate newThiefLocation, int playerToStealFrom = -1)
        {
            ...
            foreach (Intersection i in intersects)
            {
                ...
                {
                    canSteal = (Players[playerToStealFrom].TotalRessourceNumber > 0);
                    break;
                }
            }
        ...
        /// <summary>
        /// Fonction appelee lorqu'un joueur atteint la condition de victoire (10 points)
        /// Calcule le classement des joueurs et appelle l'evenement de victoire.
        /// </summary>
        ...
        /// <summary>
        /// Fonction permettant de serialiser la classe Game.
        ...
        /// <summary>
        /// Fonction permettant de deserialiser la classe Game.
        /// Cette fonction est necessaire pour le transfert d'informations par le reseau.
        /// </summary>
    ...
    /// <summary>
    /// Classe auxiliaire utilisee pour la serialisation de Game.
    /// </summary>
